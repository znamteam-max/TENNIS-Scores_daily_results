...
_COUNTRIES: Dict[str, tuple[str, str, tuple[str, ...]]] = {
    "ARG": ("Аргентина", "America/Argentina/Buenos_Aires", ("arg", "ar", "argentina", "аргентина")),
    "AUS": ("Австралия", "Australia/Sydney", ("aus", "au", "australia", "австралия")),
    "AUT": ("Австрия", "Europe/Vienna", ("aut", "at", "austria", "австрия")),
    "BEL": ("Бельгия", "Europe/Brussels", ("bel", "be", "belgium", "бельгия")),
    "BER": ("Бермуды", "Atlantic/Bermuda", ("ber", "bm", "bermuda", "бермуды")),
    "BIH": ("Босния и Герцеговина", "Europe/Sarajevo", ("bih", "ba", "bosnia", "bosnia and herzegovina", "босния")),
    "BOL": ("Боливия", "America/La_Paz", ("bol", "bo", "bolivia", "боливия")),
    "BRA": ("Бразилия", "America/Sao_Paulo", ("bra", "br", "brazil", "brasil", "бразилия")),
    "BUL": ("Болгария", "Europe/Sofia", ("bul", "bgr", "bg", "bulgaria", "болгария")),
    "CAN": ("Канада", "America/Toronto", ("can", "ca", "canada", "канада")),
    "CHI": ("Чили", "America/Santiago", ("chi", "chl", "cl", "chile", "чили")),
    "CHN": ("Китай", "Asia/Shanghai", ("chn", "cn", "china", "china pr", "китай")),
    "COL": ("Колумбия", "America/Bogota", ("col", "co", "colombia", "колумбия")),
    "CRO": ("Хорватия", "Europe/Zagreb", ("cro", "hrv", "hr", "croatia", "хорватия")),
    "CYP": ("Кипр", "Asia/Nicosia", ("cyp", "cy", "cyprus", "кипр")),
    "CZE": ("Чехия", "Europe/Prague", ("cze", "cz", "czechia", "czech republic", "чехия")),
    "DEN": ("Дания", "Europe/Copenhagen", ("den", "dnk", "dk", "denmark", "дания")),
    "DOM": ("Доминиканская Республика", "America/Santo_Domingo", ("dom", "do", "dominican republic", "доминиканская республика")),
    "ECU": ("Эквадор", "America/Guayaquil", ("ecu", "ec", "ecuador", "эквадор")),
    "EGY": ("Египет", "Africa/Cairo", ("egy", "eg", "egypt", "египет")),
    "ESA": ("Сальвадор", "America/El_Salvador", ("esa", "slv", "sv", "el salvador", "сальвадор")),
    "EST": ("Эстония", "Europe/Tallinn", ("est", "ee", "estonia", "эстония")),
    "FIN": ("Финляндия", "Europe/Helsinki", ("fin", "fi", "finland", "финляндия")),
    "FRA": ("Франция", "Europe/Paris", ("fra", "fr", "france", "франция")),
    "GBR": ("Великобритания", "Europe/London", ("gbr", "gb", "great britain", "united kingdom", "британия", "великобритания")),
    "GER": ("Германия", "Europe/Berlin", ("ger", "deu", "de", "germany", "германия")),
    "GRE": ("Греция", "Europe/Athens", ("gre", "grc", "gr", "greece", "греция")),
    "HUN": ("Венгрия", "Europe/Budapest", ("hun", "hu", "hungary", "венгрия")),
    "IND": ("Индия", "Asia/Kolkata", ("ind", "in", "india", "индия")),
    "JPN": ("Япония", "Asia/Tokyo", ("jpn", "jp", "japan", "япония")),
    "KAZ": ("Казахстан", "Asia/Almaty", ("kaz", "kz", "kazakhstan", "казахстан")),
    "KOR": ("Южная Корея", "Asia/Seoul", ("kor", "kr", "korea republic", "south korea", "южная корея", "корея")),
    "LTU": ("Литва", "Europe/Vilnius", ("ltu", "lt", "lithuania", "литва")),
    "LUX": ("Люксембург", "Europe/Luxembourg", ("lux", "lu", "luxembourg", "люксембург")),
    "MAR": ("Марокко", "Africa/Casablanca", ("mar", "ma", "morocco", "марокко")),
    "MEX": ("Мексика", "America/Mexico_City", ("mex", "mx", "mexico", "мексика")),
    "MON": ("Монако", "Europe/Monaco", ("mon", "mco", "mc", "monaco", "монако")),
    "NED": ("Нидерланды", "Europe/Amsterdam", ("ned", "nld", "nl", "netherlands", "holland", "нидерланды", "голландия")),
    "NGR": ("Нигерия", "Africa/Lagos", ("ngr", "nga", "ng", "nigeria", "нигерия")),
    "NOR": ("Норвегия", "Europe/Oslo", ("nor", "no", "norway", "норвегия")),
    "NZL": ("Новая Зеландия", "Pacific/Auckland", ("nzl", "nz", "new zealand", "новая зеландия")),
    "PAR": ("Парагвай", "America/Asuncion", ("par", "pry", "py", "paraguay", "парагвай")),
    "PER": ("Перу", "America/Lima", ("per", "pe", "peru", "перу")),
    "POL": ("Польша", "Europe/Warsaw", ("pol", "pl", "poland", "польша")),
    "POR": ("Португалия", "Europe/Lisbon", ("por", "prt", "pt", "portugal", "португалия")),
    "RSA": ("ЮАР", "Africa/Johannesburg", ("rsa", "zaf", "za", "south africa", "юар", "южная африка")),
    "SRB": ("Сербия", "Europe/Belgrade", ("srb", "rs", "serbia", "сербия")),
    "SUI": ("Швейцария", "Europe/Zurich", ("sui", "che", "ch", "switzerland", "швейцария")),
    "SVK": ("Словакия", "Europe/Bratislava", ("svk", "sk", "slovakia", "словакия")),
    "SWE": ("Швеция", "Europe/Stockholm", ("swe", "se", "sweden", "швеция")),
    "THA": ("Таиланд", "Asia/Bangkok", ("tha", "th", "thailand", "таиланд")),
    "TPE": ("Китайский Тайбэй", "Asia/Taipei", ("tpe", "twn", "tw", "chinese taipei", "taiwan", "тайвань", "китайский тайбэй")),
    "TUR": ("Турция", "Europe/Istanbul", ("tur", "tr", "turkiye", "turkey", "турция")),
    "UKR": ("Украина", "Europe/Kyiv", ("ukr", "ua", "ukraine", "украина")),
    "URU": ("Уругвай", "America/Montevideo", ("uru", "ury", "uy", "uruguay", "уругвай")),
    "USA": ("США", "America/New_York", ("usa", "us", "united states", "united states of america", "сша")),
    "ESP": ("Испания", "Europe/Madrid", ("esp", "es", "spain", "испания")),
}
...
def apply_team_context(events: Iterable[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    for event in rows:
        if not is_davis_cup_event(event):
            continue
        tie_key = str(event.get("team_tie_key") or "")
        if not tie_key:
            continue
        groups[(str(event.get("tournament_source_name") or ""), tie_key)].append(event)
