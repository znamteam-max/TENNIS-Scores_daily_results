...
_COUNTRIES: Dict[str, tuple[str, str, tuple[str, ...]]] = {
    ...
    "BUL": ("Болгария", "Europe/Sofia", ("bul", "bgr", "bulgaria", "болгария")),
    ...
    "CRO": ("Хорватия", "Europe/Zagreb", ("cro", "hrv", "croatia", "хорватия")),
    "CYP": ("Кипр", "Asia/Nicosia", ("cyp", "cyprus", "кипр")),
    "CZE": ("Чехия", "Europe/Prague", ("cze", "czechia", "czech republic", "чехия")),
    "DEN": ("Дания", "Europe/Copenhagen", ("den", "dnk", "denmark", "дания")),
    ...
    "ESA": ("Сальвадор", "America/El_Salvador", ("esa", "slv", "el salvador", "сальвадор")),
    ...
    "GRE": ("Греция", "Europe/Athens", ("gre", "grc", "greece", "греция")),
    ...
    "MON": ("Монако", "Europe/Monaco", ("mon", "mco", "monaco", "монако")),
    "NED": ("Нидерланды", "Europe/Amsterdam", ("ned", "nld", "netherlands", "holland", "нидерланды", "голландия")),
    "NGR": ("Нигерия", "Africa/Lagos", ("ngr", "nga", "nigeria", "нигерия")),
    ...
    "POR": ("Португалия", "Europe/Lisbon", ("por", "prt", "portugal", "португалия")),
    ...
    "URU": ("Уругвай", "America/Montevideo", ("uru", "ury", "uruguay", "уругвай")),
